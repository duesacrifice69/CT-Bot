...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("content").setDescription("Content of the embed")
    )
    .addStringOption((option) =>
      option.setName("title").setDescription("Title of the embed")
    )
    .addStringOption((option) =>
      option.setName("url").setDescription("url of the embed")
    )
    .addStringOption((option) =>
